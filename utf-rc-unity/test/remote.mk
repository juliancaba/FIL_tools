...
DEFINES += -D UNITY_SUPPORT_64 -D UNITY_INCLUDE_DOUBLE -D UNITY_NO_WEAK -D RCUNITY_TEST
SRC = ../src/unity.c ../src/rc-unity_remote.c tests/testunity.c tests/test_rc-unity_remote.c build/testunityRunner.c
INC_DIR = -I ../src
...
coverage: $(BUILD_DIR)/testunityRunner.c
	...
	gcov unity.c | head -3
	cd $(BUILD_DIR) && \
	gcov unity_time.c | head -3
	grep '###' $(BUILD_DIR)/unity.c.gcov -C2 || true
	grep '###' $(BUILD_DIR)/rc-unity_remote.c.gcov -C2 || true	
...
$(BUILD_DIR)/testunityRunner.c: tests/testunity.c tests/test_rc-unity_remote.c | $(BUILD_DIR)
	awk $(AWK_SCRIPT) tests/testunity.c tests/test_rc-unity_remote.c > $@
