...
SRC = ../src/unity.c ../src/rc-unity.c tests/testunity.c tests/test_rc-unity.c build/testunityRunner.c
INC_DIR = -I ../src
...
coverage: $(BUILD_DIR)/testunityRunner.c
	...
	gcov unity.c | head -3
	cd $(BUILD_DIR) && \
	gcov rc-unity.c | head -3
	grep '###' $(BUILD_DIR)/unity.c.gcov -C2 || true
	grep '###' $(BUILD_DIR)/rc-unity.c.gcov -C2 || true
...
$(BUILD_DIR)/testunityRunner.c: tests/testunity.c tests/test_rc-unity.c | $(BUILD_DIR)
	awk $(AWK_SCRIPT) tests/testunity.c tests/test_rc-unity.c > $@
